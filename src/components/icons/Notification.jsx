...
const NotificationIcon = ({ className, ...props }) => {
    return (
        <svg className={className} {...props} width="32" height="32" viewBox="0 0 32 32" fill="white" stroke="white" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
